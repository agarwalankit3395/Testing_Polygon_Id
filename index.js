...
async function GetAuthRequest(req, res) {
  ...
  const hostUrl = process.env.ngrok;
//   const hostUrl = "https://19c1-103-87-58-9.ngrok-free.app"; // Not Working when running ngrok on port 8080 also (ngrok http 8080)
  const sessionId = 1;
  ...
  const proofRequest = {
      ...
      query: {
        ...
        context: 'https://raw.githubusercontent.com/iden3/claim-schema-vocab/main/schemas/json-ld/kyc-v3.json-ld#KYCAgeCredential',
        credentialSubject: {
          birthday: {
            $lt: 20230427,
          },
